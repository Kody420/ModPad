...
#define KEY_MEDIA_PLAYPAUSE 0xcd
#define KEY_MEDIA_PLAY 0xb0
#define KEY_MEDIA_PAUSE 0xb1
#define KEY_MEDIA_FAST_FORWARD 0xb3
#define KEY_MEDIA_RANDOM_PLAY 0xb9
#define KEY_MEDIA_PREVIOUSSONG 0xb6
#define KEY_MEDIA_NEXTSONG 0xb5
#define KEY_MEDIA_EJECT 0xb8
#define KEY_MEDIA_VOLUMEUP 0xe9
#define KEY_MEDIA_VOLUMEDOWN 0xea
#define KEY_MEDIA_MUTE 0xe2
#define KEY_MEDIA_WWW 0x8a
...
//My custom keys
#define KEY_RESERVED 0x100
#define KEY_EFFECT1 0x101
#define KEY_EFFECT2 0x102
#define KEY_EFFECT3 0x103
#define KEY_EFFECT4 0x104
#define KEY_EFFECT5 0x105
#define KEY_EFFECT6 0x106
#define KEY_EFFECT7 0x107
#define KEY_NEXT_EFFECT 0x108
#define KEY_PREV_EFFECT 0x109

#define KEY_RESERVED2 0x200
