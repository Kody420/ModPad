...
LedMatrxPins_t pins;	//Creating a global struct idn if its bad
...
/*
Function description:
	Controlling outputs (leds) based on the value in array Brightness. Timer0 overflow is used to have a specific refresh frequency.
*/
